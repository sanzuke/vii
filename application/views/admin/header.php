                    ...
                    <li class="dropdown notif-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="badge bg-important">
                                <?php
                                $getNum = $this->db->query("SELECT * FROM ss_user WHERE enable ='0' AND status = '3'");
                                $jml = $getNum->num_rows();
                                echo $jml;
                                ?>
                            </span>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <div class="list-group">
                                    <?php
                                    foreach ($getNum->result_array() as $key => $value) {
                                    ?>
                                    <a class="list-group-item">
                                        <b><i class="fa fa-user-plus"></i> <?php echo $value['name'] ?></b><br>(<?php echo $value['usercode'] ?>)
                                    </a>
                                    <?php } ?>
                                ...
                                <li class="user-footer">
                                   <!--  <div class="pull-left">
                                    ...
                                    <div class="pull-right">
										<form method="post" action="<?php echo base_url().'index.php/adminlogin/logout';?>">
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel" style="display:none;">
                        <div  class="pull-center" align="center" >
                            <img src="<?php echo base_url() . "application/views/themes/default/images/". $logo;?>" class="" style="width:75px;" />
                        </div>
